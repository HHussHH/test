import {filteredUsersList, getDeletedUsersInfo, getUsersList, setDeletedUsersInfo, setUsersList} from "./usersData.js";
...
const deleteUser = async (id) => {
  const request = await fetch(`https://dummyjson.com/users/${id}?select=firstName,id,image,phone,email`, {
    method: "DELETE",
  });
  ...
  filteredUsersList(getUsersList())
};
